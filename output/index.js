...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nftItemHex = tonweb_1.default.utils.bytesToHex(fs_1.default.readFileSync('src/build/nft-item-editable.cell'));
        const deployer = new deployer_1.default(config, nfts, nftItemHex);
        deployer.start();
    });
})();
